...
- [x] Resolve late sign-off blockers: autocrlf false-positive review capture and protocol-error descendant cleanup; independently reviewed with no blockers, published through `ba54adc`, fast-forward integrated, and live verified.
