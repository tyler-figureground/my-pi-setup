...
const installedBrowserExecutable =
  [
...
test(
  "platform composition wires MCP and browser lazily without starting external resources",
  {
    skip: installedBrowserExecutable
      ? false
      : "no installed Chrome or Edge executable",
  },
  async () => {
